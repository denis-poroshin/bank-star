...
public class OfferDescriptionText {
    ...
    private String TEXT_TOP_SAVING = "Откройте свою собственную «Копилку» с нашим банком! «Копилка» — это уникальный " +
    ...
    private String TEXT_SIMPLE_LOAN = "Откройте мир выгодных кредитов с нами!" +
    ...
    public String getTEXT_TOP_SAVING() {
        return TEXT_TOP_SAVING;
    }

    public String getTEXT_SIMPLE_LOAN() {
        return TEXT_SIMPLE_LOAN;
    }
}
